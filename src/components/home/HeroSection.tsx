...
export default function HeroSection() {
  ...
  // Only animate AFTER mount — server render shows full content at opacity 1
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-24">
          ...
          >
            ...
            <h1 className="text-5xl lg:text-7xl font-serif text-navy-900 leading-tight mb-6 perspective-text">
              Where Movement <br /> Meets{' '}
              <span className="text-teal-600 italic relative inline-block">
                Mental Peace
