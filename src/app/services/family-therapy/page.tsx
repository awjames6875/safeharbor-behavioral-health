        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div>
                <h3 className="text-xl font-semibold text-teal-600 mb-4">Our Family Therapy Success Metrics:</h3>
                <div className="space-y-4">
                  <div className="border-l-4 border-teal-500 pl-4">
                    <p className="text-2xl font-bold text-navy-800">87%</p>
                    <p className="text-sm text-gray-700">of families report improved communication within 8 sessions</p>
                  </div>
                  <div className="border-l-4 border-teal-500 pl-4">
                    <p className="text-2xl font-bold text-navy-800">81%</p>
                    <p className="text-sm text-gray-700">of families show reduced conflict and increased cooperation</p>
                  </div>
                  <div className="border-l-4 border-teal-500 pl-4">
                    <p className="text-2xl font-bold text-navy-800">92%</p>
                    <p className="text-sm text-gray-700">of parents report feeling more confident in their parenting</p>
                  </div>
                  <div className="border-l-4 border-teal-500 pl-4">
                    <p className="text-2xl font-bold text-navy-800">79%</p>
                    <p className="text-sm text-gray-700">of families maintain positive changes 6 months post-treatment</p>
                  </div>
                </div>
              </div>
            </div>
