    ...
    <div className="min-h-screen">
      <section className="bg-gradient-to-br from-navy-700 to-navy-900 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl font-bold mb-4">Psychiatric Evaluations</h1>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            <div className="bg-teal-50 border-2 border-teal-200 rounded-2xl p-10 mb-10">
              <h2 className="text-2xl font-bold text-navy-800 mb-4">Looking for a Psychiatric Evaluation?</h2>
              <p className="text-gray-700 text-lg mb-6">
                ...
                our Body &amp; Brain program, we understand that some families need psychiatric evaluation services. We&apos;re happy to help 
            ...
            <div className="text-left bg-gray-50 rounded-xl p-8">
              ...
              <ul className="space-y-2 text-gray-700 mb-6">
                ...
                <li className="flex items-start"><span className="text-teal-500 mr-2">✓</span> Behavioral assessments for children</li>
